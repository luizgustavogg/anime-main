        ...
        <div class="flex flex-col flex-1">
            ...
            <main class="h-full pb-16 overflow-y-auto">
                <div class="container px-6 mx-auto grid">
                    ...
                    <?php
                    $id = $_GET['id'];
                    $sql = mysqli_query($conn, "SELECT * FROM anime WHERE idAnime = '$id'");
                    $row = mysqli_fetch_assoc($sql);
                    ?>
                    <div class="anime px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                        <form action="">
                            <div class="errortxt"></div>
                            <label class="block text-sm">
                                <span class="text-gray-700 dark:text-gray-400">Name</span>
                                <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red dark:text-gray-300 dark:focus:shadow-outline-gray form-input" name="nome" placeholder="Black Clover" value="<?php echo $row['nome']; ?>" />
                            </label>
                            ...
                            <label class="block mt-4 text-sm">
                                ...
                                <select class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-red-400 focus:outline-none focus:shadow-outline-red dark:focus:shadow-outline-gray" name="categoria">
                                    <?php
                            ...
                            <label class="block mt-4 text-sm">
                                ...
                                <textarea class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-textarea focus:border-red-400 focus:outline-none focus:shadow-outline-red dark:focus:shadow-outline-gray" rows="3" placeholder="Digite descrição do anime" name="descricao"><?php
                                    $id = $_GET['id'];
                                    $sql = mysqli_query($conn, "SELECT * FROM anime WHERE idAnime = '$id'");
                                    $row = mysqli_fetch_assoc($sql);
                                    echo $row['descricao'];
                                ...
                                <div class="input__item">
                                    ...
                                    <div class="file-upload" style="max-width: 300px">
                                        <div class="file-select">
                                            <div class="file-select-button" id="fileName"><?php echo $row['img']; ?></div>

...
$id = $_GET['id'];
$sql = mysqli_query($conn, "SELECT * FROM categoria WHERE idCategoria = '$id'");
        ...
        <div class="flex flex-col flex-1">
            ...
            <main class="h-full pb-16 overflow-y-auto">
                <div class="container px-6 mx-auto grid">
                    ...
                    <div class="categoria px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                        <form action="">
                            <div class="errortxt"></div>
                            <label class="block text-sm">
                                <span class="text-gray-700 dark:text-gray-400">Name</span>
                                <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red dark:text-gray-300 dark:focus:shadow-outline-gray form-input" name="nome" placeholder="Romance" 
                                value='<?php echo $row['nome']?>'/>
                            </label>

                            <label class="block mt-4 text-sm">
                                <span class="text-gray-700 dark:text-gray-400">Capa - <?php echo $row['img']?></span>
...
<script src="assets/js/editcategoria.js"></script>

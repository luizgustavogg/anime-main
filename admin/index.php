<?php 
  ...
  $anime = 0;
  while(mysqli_fetch_assoc($sqlanime)){
    $anime++;
  }
  $sqlcategoria = mysqli_query($conn,"SELECT * FROM categoria");
  $categoria = 0;
  while(mysqli_fetch_assoc($sqlcategoria)){
    $categoria++;
  }
  $sqlcomentario = mysqli_query($conn, "SELECT * FROM comentario");
  $comentario = 0;

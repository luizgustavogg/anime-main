        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    $sqlanimesearch = mysqli_query($conn, "SELECT * FROM anime WHERE nome = '$searchTerm'");
                    if (mysqli_num_rows($sqlanimesearch) < 1) {
                        echo "
                        ...
                        $rowanimesearch = mysqli_fetch_assoc($sqlanimesearch);
                        echo "
                                    <div class='product__page__content'>
                                        <div class='product__page__title'>
                                            <div class='row'>
                                        ...
                                        <div class='row'>  
                        ";
                        $sqlanimets = mysqli_query($conn, "SELECT * FROM anime WHERE nome = '$searchTerm'");
                        while ($rowanimets = mysqli_fetch_assoc($sqlanimets)) {
                            ...
                            $categoria = $rowanimets['FK_idCategoria'];

    ...
    <nav class="navbar navbar-icon-top navbar-expand-lg navbar-dark " style="background: #070720">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ">
                ...
                <li class="nav-item">
                    <a class='nav-link icon-login' href='../signin/login.php'>
                ...
                <div class="col-lg-6">
                    <div class="login__form">
                        ...
                        <form action="#" method="">
                            ...
                            <div class="input__item">
                                <input type="text" placeholder="Your Name" name="nome">
                        ...
                        <h5>Already have an account? <a href="../signin/login.php">Log In!</a></h5>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="login__register">
                        <h3>Ja tenho uma conta</h3>
                        <a href="../signin/login.php" class="primary-btn">Fazer Login</a>
                    </div>
                </div>
            </div>
        </div>
